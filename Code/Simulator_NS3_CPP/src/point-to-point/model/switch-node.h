...
class SwitchNode : public Node{
	...
	std::map<Ipv4Address, EcmpEntry> m_ecmpRouteTable;
	uint32_t GetHashValueFromCustomHeader(const CustomHeader &ch);
	EcmpEntry GetEcmpRouteEntry (const Ipv4Address dip) const;
