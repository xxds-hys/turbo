...
//                   MakeEnumChecker (CLOSED, "Closed"))
    ...
    .AddTraceSource ("Rx",
                     ...
                     "ns3::TcpSocketBase::TcpTxRxTracedCallback")
    .AddTraceSource ("Bx",
                     "Buffer a newly invalid packet into buffer",
                     MakeTraceSourceAccessor (&TcpSocketBase::m_bxTrace),
                     "ns3::TracedCallback")
...
TcpSocketBase::ReceivedData (Ptr<Packet> p, const TcpHeader& tcpHeader)
{
  ...
  // m_rxTrace (p, tcpHeader, this);
  // std::cout << "Yes" << std::endl;
  m_bxTrace (p, tcpHeader);
